                  ...
                  <div className="bg-[#121212] p-3.5 rounded-xl space-y-2.5 animate-in fade-in">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                      <input
                        ...
                        className="bg-[#181818] rounded-lg px-3 py-2 text-xs text-white focus:outline-none focus:ring-1 focus:ring-[#7B61FF]"
                        autoFocus
                      />
                      <input
                        type="email"
                    ...
                    <div className="flex items-center justify-end gap-2 pt-1">
                      ...
                      <button
                        ...
                        className="px-4 py-1.5 rounded-lg bg-[#7B61FF] hover:bg-[#684DE6] text-xs text-white font-bold cursor-pointer disabled:opacity-50"
                      >
                        Set Host
                      </button>
                    </div>
                ...
                {samples.length > 0 && (
                  <div className="space-y-2">
                    {samples.map((sample) => (
                      <div
                        key={sample.id}
                        className="bg-[#121212] p-3 rounded-xl flex items-center justify-between gap-3 text-xs"
                      >
                        <div className="flex items-center gap-3 min-w-0 flex-1">
                          <div className="w-7 h-7 rounded-lg bg-[#7B61FF]/10 text-[#7B61FF] flex items-center justify-center shrink-0">
