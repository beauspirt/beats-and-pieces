...
export default function BattleDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const battle = sampleCompetitions.find((c) => c.id === resolvedParams.id) || sampleCompetitions[0];
  ...
  // Anonymized anti-cheating track queue
  const blindTracks = [
    { id: "blind-01", placeholder: "Beat 01", bpm: 92, audioUrl: "/api/stream/blind-01" },
    { id: "blind-02", placeholder: "Beat 02", bpm: 88, audioUrl: "/api/stream/blind-02" },
    { id: "blind-03", placeholder: "Beat 03", bpm: 90, audioUrl: "/api/stream/blind-03" },
    { id: "blind-04", placeholder: "Beat 04", bpm: 94, audioUrl: "/api/stream/blind-04" },
    { id: "blind-05", placeholder: "Beat 05", bpm: 86, audioUrl: "/api/stream/blind-05" },
    { id: "blind-06", placeholder: "Beat 06", bpm: 91, audioUrl: "/api/stream/blind-06" },
    { id: "blind-07", placeholder: "Beat 07", bpm: 93, audioUrl: "/api/stream/blind-07" },
    { id: "blind-08", placeholder: "Beat 08", bpm: 89, audioUrl: "/api/stream/blind-08" },
  ];
  ...
  return (
    <div className="w-full space-y-8 animate-in fade-in duration-300">
      ...
      {/* ========================================================================= */}
      {/* STAGE 2: PUBLIC PRESELECTION (PERCENTAGE-BASED VALIDATION & ANTI-CHEATING SHIELD) */}
      {/* ========================================================================= */}
      {activeTab === "rating" && (
        <div className="space-y-4">
          
          {/* Anti-Cheating & Percentage Ballot Card */}
            ...
            <div className="flex items-start gap-3.5">
              ...
              <div className="text-sm text-[#D1D1D1] leading-relaxed flex-1">
                <span className="font-bold text-white block mb-0.5 text-base">
                  Blind Anonymized Preselection & Anti-Cheating Shield
                </span>
                Beats are randomly shuffled with all producer tags, filenames, and metadata stripped on the server to prevent vote brigading.
          ...
          {/* Blind Rating Track Queue with Anonymized Streams */}
