    ...
    <HostGuard>
      <div className="max-w-5xl mx-auto space-y-8 animate-in fade-in duration-300 py-4">
        ...
        {hostedBattles.length === 0 ? (
          <div className="bg-[#181818] rounded-2xl p-8 text-center space-y-3 shadow-lg">
            ...
            >
              ...
              <form onSubmit={handleSave} className="space-y-5 text-left text-xs">
                ...
                <div className="flex items-center justify-end gap-3 pt-4">
                  ...
                  <button
                    type="submit"
                    className="px-7 py-2.5 rounded-xl bg-[#FF8A65] hover:bg-[#FF7A50] text-white text-xs font-bold transition-all shadow-md active:scale-95 cursor-pointer"
                  >
