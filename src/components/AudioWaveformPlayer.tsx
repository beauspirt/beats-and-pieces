    ...
    >
      ...
      <div className={`flex-1 relative overflow-hidden bg-transparent ${compact ? "h-12 sm:h-14" : "h-14 sm:h-18"}`}>
        ...
        <div className="absolute bottom-1 right-1 flex items-center pointer-events-none select-none z-10">
          <div className="px-2 py-0.5 rounded-3xl bg-[#141414]/90 backdrop-blur-sm shadow-sm flex items-center gap-1 text-xs font-sans tabular-nums">
            {isThisTrackActive ? (
              <>
        ...
        {showDownload && (
          <button
            ...
            className="absolute top-1 right-1 p-1.5 rounded-3xl bg-[#1C1C1C] text-[#888888] hover:text-white hover:bg-[#252525] transition-colors"
          >
