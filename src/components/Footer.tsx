...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-[#121212] py-8 sm:py-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-5 text-[#888888]">
          ...
          >
            <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
              <path d="M15.386.5C10.74.5 7 4.244 7 8.89c0 4.583 3.74 8.297 8.386 8.297 4.618 0 8.364-3.714 8.364-8.297C23.75 4.244 20.004.5 15.386.5zM0 23.5h4.15V.5H0v23z" />
            </svg>
          </a>
        </div>
